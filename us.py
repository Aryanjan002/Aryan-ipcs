...
def unitedstates():
    global page
    res = requests.get('https://www.insecam.org/en/bycountry/US/', headers=headers)
    ...
    print("  |CS   '--'     | ")
    print("{}  '--------------'----------{}------------------.  ").format(r,w)
    print("{}  | {}Author  : {}ARYAN {}     | {}AFGHAN {}N{}{}ARYAN HACK TEM      | ").format(r,w,r,w,r,ir,reset,w)
    print("{}  | {}Youtube : {}ARYAN HACK {}| {}+93-813-6487-3762 {}|").format(r,w,w,w,lgray,w)
    print("{}  '------------------------------------{}-------'  ").format(r,w)
